const scenes = [
  ...
  { title: '凉宫春日', text: '（猛地回头，手指以不可抗拒的姿态指着我的鼻尖）这次阿虚你也要来！敢缺席的话就判处死刑，外加流放西伯利亚挖土豆！' },
  { title: '旁白', text: '说罢，她一把拽住朝比奈学姐的衣袖，像拖着战利品一样冲出了门。望着被粗暴拉开的拉门，我深深地、沉重地叹了一口气。就算你把我流放到西伯利亚，我也不会在那里给你挖土豆的。' },
  { title: '古泉一树', text: '（带着那招牌式的温和笑容走近）呵呵，既然团长都下达神谕了，那我们也只能从命了吧。走吧？' },
  ...
  { title: '电研社社长', text: '（紧紧护住机箱，猛地转身狂奔）谁、谁会给你啊！！！' },
  { title: '旁白', text: '伴随着急促的脚步声，奇怪的事情发生了。周围的走廊景象开始扭曲，边界变得若即若离，像是融化在水中的水彩画，朦胧得看不到尽头。' },
  { title: '电研社社长', text: '（惊恐地放慢脚步，环顾四周）这、这到底是什么鬼地方？！' },
  ...
  { title: '电研社社长', text: '（咬紧牙关，四处张望）可恶！难道我的新电脑就要在这里陨落了吗？！……不，等等！旁边有一间没有被空间侵蚀的教室！' },
